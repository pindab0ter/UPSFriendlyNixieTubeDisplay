...
circuit_connector_definitions["million-reinforced-nixie-tube"] = circuit_connector_definitions.create_single(
    belt_connector_template,
    {
        variation = 1,
        main_offset = util.by_pixel(31, -29),
        shadow_offset = util.by_pixel(49, -8),
        show_shadow = true,
    }
)
...
data:extend {
    {
        type = "recipe",
        name = "million-reinforced-nixie-tube",
        enabled = false,
        energy_required = 5,
        ingredients = {
            { type = "item", name = "reinforced-nixie-tube", amount = 7 },
            { type = "item", name = "steel-plate",           amount = 3 },
            { type = "item", name = "iron-stick",            amount = 10 },
        },
        results = {
            { type = "item", name = "million-reinforced-nixie-tube", amount = 1 }
        }
    },
    {
        type = "item",
        name = "million-reinforced-nixie-tube",
        icon = "__UPSFriendlyNixieTubeDisplay__/graphics/million-reinforced-nixie-tube-icon.png",
        icon_size = 72,
        subgroup = "circuit-network",
        order = "a[lamp]-b[nixie-tube]-c[small]",
        place_result = "million-reinforced-nixie-tube",
        stack_size = 50
    },
    {
        type = "lamp",
        ...
        minable = {
            hardness = 0.2,
            mining_time = 0.5,
            result = "million-reinforced-nixie-tube"
        },
        max_health = 200,
        resistances = {
            {
        ...
        picture_off = {
            filename = "__UPSFriendlyNixieTubeDisplay__/graphics/million-reinforced-nixie-tube-base.png",
            priority = "high",
            width = 110,
            height = 42,
            frame_count = 1,
        ...
        circuit_connector = {
            sprites = circuit_connector_definitions["million-reinforced-nixie-tube"].sprites,
            points = {
                wire = {
                    green = util.by_pixel(43.5, -19),
                    red = util.by_pixel(43, -25),
                },
                shadow = {
                    green = util.by_pixel(57, -8),
                    red = util.by_pixel(61, -8),
                },
            },
        },
    ...
    },
    {
        ...
        name                           = "million-reinforced-nixie-tube-sprite",
        icon                           = "__UPSFriendlyNixieTubeDisplay__/graphics/million-reinforced-nixie-tube-icon.png",
        icon_size                      = 72,
        flags                          = {
            "placeable-off-grid",
        ...
        minable                        = { hardness = 0.0, mining_time = 0.0, result = "million-reinforced-nixie-tube" },
        max_health                     = 1,
        order                          = "z[zebra]",
