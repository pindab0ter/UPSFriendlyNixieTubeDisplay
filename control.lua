...
local function onRemoveEntity(entity) --or event
	debugger("onRemoveEntity")
...
local function onTickController(entity)
  ...
  if not entity.valid then
    ...
    --onRemoveEntity{entity}
		--game.print(dump(entity))
    game.print("Removed an invalid nixie " .. entity.unit_number .. " (you're welcome)")
    return
  end
