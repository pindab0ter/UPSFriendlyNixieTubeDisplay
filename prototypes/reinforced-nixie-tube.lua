...
data:extend {
    ...
    },
    {
        type = "item",
        name = "reinforced-nixie-tube",
        icon = "__UPSFriendlyNixieTubeDisplayFixed__/graphics/reinforced-nixie-tube-icon.png",
        icon_size = 32,
    ...
    },
    {
        ...
        picture_off = {
            filename = "__UPSFriendlyNixieTubeDisplayFixed__/graphics/reinforced-nixie-tube-base.png",
            priority = "high",
            width = 40,
            height = 64,
            frame_count = 1,
